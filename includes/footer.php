...
<div class="footer">
    ...
    <div class="socialBar">
        ...
        <a href="http://www.facebook.com/EventsProductionGmu"><img src="'); if( $_SERVER['REQUEST_URI'] !== '/newSite/index.shtml' && $_SERVER['REQUEST_URI'] !== $root){ print('../');} print('images/fc-webicon-facebook.png"></a>
    </div>
    <p><em>Official website of Events Production, an office of <a href="http://studentcenters.gmu.edu/">Student Centers</a> at <a href="http://www.gmu.edu/">George Mason University<?php print($root); ?></em></a>
    </p>
</div>');
?>